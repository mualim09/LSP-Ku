        ...
        <div class="counters custom-counters">
          <div class="col-md-3 col-sm-6">
            <div class="counter">
              ...
              <strong class="text-color-light" data-to="6" data-append="+">0</strong>
                <label>ARMADA</label>
              </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="counter">
              ...
              <strong class="text-color-light" data-to="9" data-append="+">0</strong>
              ...
              <div id="team-content-1" class="dialog dialog-lg zoom-anim-dialog mfp-hide p-xlg">
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <img src="<?=base_url()?>assets/img/logo1_transparent.png" class="custom-rounded-image img-responsive mb-lg mt-xlg" alt="">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
          <ul id="loadMoreWrapper" class="image-gallery sort-destination lightbox" data-sort-id="gallery" data-total-pages="2" data-plugin-options="{'delegate': 'a.lightbox-portfolio', 'type': 'image', 'gallery': {'enabled': true}}">
                ...
                <a href="<?=base_url()?>assets/img/projects/project-6.jpg" class="lightbox-portfolio">
                  <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                    <span class="thumb-info-wrapper">
                      ...
                      <span class="thumb-info-title">
                        <span class="thumb-info-inner">PT. LMJ 2</span>
                ...
                <a href="<?=base_url()?>assets/img/projects/project-6.jpg" class="lightbox-portfolio">
                  <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                    <span class="thumb-info-wrapper">
                      ...
                      <span class="thumb-info-title">
                        <span class="thumb-info-inner">PT. LMJ 7</span>
                        <span class="thumb-info-type">7</span>
                      </span>
                    </span>
                  </span>
                </a>
                ...
                <a href="<?=base_url()?>assets/img/projects/project-6.jpg" class="lightbox-portfolio">
                  <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                    <span class="thumb-info-wrapper">
                      ...
                      <span class="thumb-info-title">
                        <span class="thumb-info-inner">PT. LMJ 8</span>
                        <span class="thumb-info-type">8</span>
                      </span>
                    </span>
                  </span>
                </a>
